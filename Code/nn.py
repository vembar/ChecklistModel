...
class GRU(object):
    ...
    def __init__(self, input_dim, hidden_dim, with_batch=True, name='LSTM'):
        ...
        self.u_z = shared_orthogonal((hidden_dim, hidden_dim), name + '__u_z')
        self.b_z = shared((hidden_dim,), name + '__b_z')

        # Reset gate weights and bias
        self.w_r = shared((input_dim, hidden_dim), name + '__w_r')
        self.u_r = shared_orthogonal((hidden_dim, hidden_dim), name + '__u_r')
        self.b_r = shared((hidden_dim,), name + '__b_r')

        # New memory content weights and bias
        self.w_c = shared((input_dim, hidden_dim), name + '__w_c')
        self.u_c = shared_orthogonal((hidden_dim, hidden_dim), name + '__u_c')
